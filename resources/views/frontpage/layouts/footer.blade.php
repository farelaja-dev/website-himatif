<footer class="bg-[#FEF9F1] text-[#002F49]">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row justify-between gap-8 py-6 border-t-2 border-[#002F49]">
            ...
            <div class="lg:w-1/3">
                ...
                <a href="{{ route('frontpage.berita') }}" class="flex items-center font-semibold hover:underline">
                    Lihat Semua Blog
                    <svg width="16" height="16" fill="#002F49" viewBox="0 0 24 24" class="ml-1">
        ...
        <!-- Copyright -->
        <div class="border-t-2 border-[#002F49] py-4 text-center font-bold">
